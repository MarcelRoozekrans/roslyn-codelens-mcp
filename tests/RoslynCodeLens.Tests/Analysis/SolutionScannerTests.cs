...
public class SolutionScannerTests
{
    ...
    [Fact]
    public void GeneratedTrees_AreYielded_WhenIncludeGeneratedIsSet()
    {
        // find_obsolete_usage and find_event_subscribers deliberately report hits in generated code
        // and flag them IsGenerated rather than dropping them. Without this opt-in, migrating them
        // onto the scanner would silently delete results.
        var (loaded, resolver) = RenameTestWorkspace.Create(
            ("Real.cs", "namespace Demo; public class Real { }"),
            ("Machine.g.cs", "namespace Demo; public class Machine { }"),
            ("Header.cs", "// <auto-generated>\nnamespace Demo; public class Header { }"));
